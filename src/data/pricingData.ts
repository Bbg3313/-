...
export const PRICING_SECTIONS: PricingSection[] = [
    ...
    tables: [
      {
        ...
        rows: [
          ["점 제거\u200B(크기에 따라 금액변동 / 상담 후 진행)", "6,000 ~", "120,000"],
          ["검버섯 제거", "10,000 ~", "250,000"],
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["제네시스 토닝", "80,000", "350,000", "650,000"],
  ...
  },
  {
    ...
    tables: [
      ...
      {
        headers: ["볼뉴머 아이 리프팅", "100샷", "200샷", "600샷"],
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["LDM 물방울 리프팅", "수분 / 피부탄력", "110,000", "300,000", "470,000"],
          ["라라필", "피지선 억제·좁쌀 여드름 재발 방지", "80,000", "220,000", "350,000"],
          ["이온토", "피부진정 / 재생·회복", "60,000", "150,000", "250,000"],
          ["플라필", "피지선 억제·항염·물광", "100,000", "270,000", "400,000"],
        ],
        priceColumns: 3,
      },
    ],
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["라라필 여드름관리", "100,000", "450,000"],
          ["플라필 여드름관리", "120,000", "550,000"],
          ["라라필 + 제네시스토닝", "120,000", "550,000"],
          ["플라필 + 제네시스토닝", "140,000", "700,000"],
          ["라라샷 + 제네시스 여드름관리", "120,000", "550,000"],
          ["라라샷 + 인피니", "220,000", "1,050,000"],
    ...
    laserHairRows: [
      {
        ...
        five: hairSingle("50,000"),
        ten: hairSingle("80,000"),
      },
      {
        area: "",
        detail: "인중+겨드랑이 / 헤어라인 / 턱 / 구레나룻",
        once: hairSingle("20,000"),
        five: hairSingle("75,000"),
        ten: hairSingle("140,000"),
      },
      { area: "", detail: "이마전체", once: hairSingle("20,000"), five: hairSingle("80,000"), ten: hairSingle("150,000") },
      { area: "", detail: "얼굴 하관", once: hairSingle("40,000"), five: hairSingle("170,000"), ten: hairSingle("300,000") },
      {
        area: "",
        detail: "얼굴전체",
        once: hairSingle("90,000"),
        five: hairSingle("400,000"),
        ten: hairSingle("750,000"),
      },
      { area: "", detail: "뒷목부분( 머리카락부분)", once: hairSingle("30,000"), five: hairSingle("120,000"), ten: hairSingle("210,000") },
      ...
      { area: "", detail: "팔상완", once: hairSingle("57,000"), five: hairSingle("230,000"), ten: hairSingle("410,000") },
      { area: "", detail: "팔하완", once: hairSingle("57,000"), five: hairSingle("230,000"), ten: hairSingle("410,000") },
      ...
      { area: "", detail: "다리전체", once: hairSingle("130,000"), five: hairSingle("590,000"), ten: hairSingle("1,150,000") },
      {
        area: "",
        detail: "비키니라인",
        once: hairSingle("100,000"),
        five: hairSingle("450,000"),
        ten: hairSingle("850,000"),
      },
      {
        area: "",
        detail: "브라질리언 (항문제외)",
        once: hairSingle("150,000"),
        five: hairSingle("700,000"),
        ten: hairSingle("1,300,000"),
      },
      { area: "상체", detail: "복부( 부분 )", once: hairSingle("70,000"), five: hairSingle("300,000"), ten: hairSingle("550,000") },
      { area: "", detail: "배레나룻", once: hairSingle("25,000"), five: hairSingle("100,000"), ten: hairSingle("180,000") },
      {
        area: "",
        detail: "복부 전체",
        once: hairSingle("120,000"),
        five: hairSingle("520,000"),
        ten: hairSingle("940,000"),
      },
      {
        area: "",
        detail: "등 전체",
        once: hairSingle("150,000"),
        five: hairSingle("670,000"),
        ten: hairSingle("1,250,000"),
      },
    ],
  },
  {
    ...
    laserHairRows: [
      {
        ...
        five: hairSingle("130,000"),
        ten: hairSingle("250,000"),
      },
      {
        area: "",
        detail: "인중+겨드랑이 / 헤어라인 / 구레나룻 / 턱",
        once: hairSingle("40,000"),
        five: hairSingle("180,000"),
        ten: hairSingle("340,000"),
      },
      { area: "", detail: "이마 전체", once: hairSingle("30,000"), five: hairSingle("120,000"), ten: hairSingle("210,000") },
      {
        ...
        ten: hairSingle("520,000"),
      },
      {
        area: "",
        detail: "얼굴 전체 + 진정관리",
        once: hairSingle("99,000"),
        five: hairSingle("470,000"),
        ten: hairSingle("900,000"),
      },
      ...
      { area: "팔", detail: "손등 + 손가락", once: hairSingle("40,000"), five: hairSingle("160,000"), ten: hairSingle("280,000") },
      {
        ...
        five: hairSingle("330,000"),
        ten: hairSingle("600,000"),
      },
      { area: "", detail: "팔 전체", once: hairSingle("100,000"), five: hairSingle("470,000"), ten: hairSingle("900,000") },
      { area: "하체", detail: "발등 + 발가락", once: hairSingle("50,000"), five: hairSingle("210,000"), ten: hairSingle("400,000") },
      {
        area: "",
        detail: "종아리",
      ...
      { area: "", detail: "다리 전체", once: hairSingle("160,000"), five: hairSingle("750,000"), ten: hairSingle("1,380,000") },
      {
        area: "",
        detail: "브라질리언 (항문제외)",
        once: hairSingle("150,000"),
        five: hairSingle("700,000"),
        ten: hairSingle("1,350,000"),
      },
      { area: "상체", detail: "베레나룻", once: hairSingle("30,000"), five: hairSingle("120,000"), ten: hairSingle("200,000") },
      {
        area: "",
      ...
      { area: "", detail: "복부 전체", once: hairSingle("150,000"), five: hairSingle("600,000"), ten: hairSingle("1,100,000") },
      { area: "", detail: "등 전체", once: hairSingle("180,000"), five: hairSingle("850,000"), ten: hairSingle("1,600,000") },
    ],
  },
  {
    id: "iv",
